...
testBtn.addEventListener("click", () => {
    authorSect.innerHTML = `
            ...
            <div class="img-data">
            <a href="https://www.google.com/maps/@${authorDetails.location.position.latitude},${authorDetails.location.position.longitude}z">${authorDetails.location.city ? authorDetails.location.city : "No location provided"}</a>
